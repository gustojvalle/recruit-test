...
/*
  ...
  task 1: Complete the leaderboard page.  Ordered by number of votes, descending, it should show each emoji that has been
  voted on along with the number of votes that emoji has received
